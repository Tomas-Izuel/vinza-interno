...
export default function EventosError({
  ...
  useEffect(() => {
    // Log específico para errores de eventos
    console.error("Error en sección de eventos:", error);
  }, [error]);
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600">
            No se pudieron cargar los eventos correctamente
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-600 text-center">
              Puede ser un problema temporal con la carga de datos. Intenta
