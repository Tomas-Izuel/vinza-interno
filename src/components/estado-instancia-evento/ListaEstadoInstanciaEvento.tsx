...
export function ListaEstadoInstanciaEvento({ estadosInstanciaEvento, meta }: ListaEstadoInstanciaEventoProps) {
    return (
                    ...
                    {estadosInstanciaEvento.map((estado) => (
                        <TableRow key={estado.id}>
                            ...
                            <TableCell className="text-right">
                                <Button variant="ghost" size="sm" className="text-gray-600 mr-2">
